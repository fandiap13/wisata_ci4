...
<div class="card">
  ...
  <div class="card-body">
    <form action="<?= site_url('/admin/blog/simpan'); ?>" method="POST" class="formsimpan" enctype="multipart/form-data">
      <?= csrf_field(); ?>
      <div class="form-group">
        <label for="">Judul</label>
        <input type="text" name="judul" class="form-control" placeholder="Judul..." maxlength="150" required>
